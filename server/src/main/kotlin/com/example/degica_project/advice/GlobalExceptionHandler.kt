package com.example.degica_project.advice

import com.example.degica_project.constants.ApiErrorCodes
import com.example.degica_project.dto.response.ErrorResponseDto
import com.example.degica_project.exceptions.LedgerRuntimeException
...
class GlobalExceptionHandler {
    ...
    private fun createErrorResponseDto(apiErrorCodes: ApiErrorCodes, description: String): ErrorResponseDto {
        return ErrorResponseDto(
            ...
            message = apiErrorCodes.errorMessage,
    ...
    @ExceptionHandler(LedgerRuntimeException::class)
    fun handleRuntimeExceptions(exception: LedgerRuntimeException): ResponseEntity<Any> {
